#ifndef hwa_fgo_nhcprocesser_h
#define hwa_fgo_nhcprocesser_h
...
namespace hwa_fgo {
	class nhcprocesser : public baseprocesser {
	public:
		explicit nhcprocesser(const baseprocesser& B) : baseprocesser(B) {};
