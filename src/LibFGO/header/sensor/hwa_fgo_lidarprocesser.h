#ifndef hwa_fgo_lidar_processer_h
#define hwa_fgo_lidar_processer_h
...
namespace hwa_fgo {
    ...
    public:
        ...
        void build_PPHR(std::vector<LidarFrame>& buffer, std::map<int, std::map<int, int>>& indexs, Matrix& H, Vector& r);
        bool planarpatchJacobian(std::vector<LidarFrame>& buffer, int point_id, std::map<int, int> corr_ids, Matrix& H, Vector& r);
        ...
        void removeLidar(std::vector<LidarStateIDType>& rm_lidar_state_ids);
        void removeState(std::vector<LidarStateIDType>& rm_lidar_state_ids);
        void removeIDandBuffer(std::vector<LidarStateIDType>& rm_lidar_state_ids);
		bool checkKeyframe();
