...
namespace hwa_qt {
    ...
    void qt_ins_worker::StateAugmentation()
    {
        ...
        base_par att_x_par(_name, hwa_base::par_type::CAM_ATT_X, _param.parNumber(), cam_id);
        _param.addParam(att_x_par);
        base_par att_y_par(_name, hwa_base::par_type::CAM_ATT_Y, _param.parNumber(), cam_id);
        _param.addParam(att_y_par);
        base_par att_z_par(_name, hwa_base::par_type::CAM_ATT_Z, _param.parNumber(), cam_id);
        _param.addParam(att_z_par);
        base_par crd_x_par(_name, hwa_base::par_type::CAM_CRD_X, _param.parNumber(), cam_id);
        _param.addParam(crd_x_par);
        base_par crd_y_par(_name, hwa_base::par_type::CAM_CRD_Y, _param.parNumber(), cam_id);
        _param.addParam(crd_y_par);
        base_par crd_z_par(_name, hwa_base::par_type::CAM_CRD_Z, _param.parNumber(), cam_id);
